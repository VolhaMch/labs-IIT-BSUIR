...
<template>
  ...
  <el-col class="header-logo" :span="12">
    <a href="#">
    <img src="@/assets/img/header-logo.png" alt="logo"  width="100px" height="100px"/>
</a> 
</el-col>
  <el-col :span="12"
  ><div>
    <el-button plain size="mini" class="mobile-nav" @click="menuNav"
            ><i v-if="menuIsActive" class="el-icon-menu"></i
      ...
      <el-radio-button label="bel">Bel</el-radio-button>
      <el-radio-button label="pl">Pl</el-radio-button>
    </el-radio-group>
    <el-button size="mini" type="info"
    ><i class="el-icon-upload el-icon-right"></i>Logout</el-button>
  </div></el-col>
</el-row>
  </el-header>
</template>
